...
object Defaults {
  ...
  val defaultMajor: U2 = 52 // J2SE 8.0=52, J2SE 7.0=51, J2SE 6.0=50, J2SE 5.0=49, JDK 1.4=48, JDK 1.3=47, JDK 1.2=46, JDK 1.1=45
  ...
  val staticConstructorName: String = "<clinit>"
  val staticConstructorSig: String = "()V"
}
